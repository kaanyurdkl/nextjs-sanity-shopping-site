export default function HomePage() {
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-black mb-4">Welcome to Our Store</h1>
      ...
      <div className="bg-gray-100 rounded-lg p-12 text-center mb-12">
        ...
        <p className="text-gray-600 mb-6">Explore our curated selection of premium fashion</p>
